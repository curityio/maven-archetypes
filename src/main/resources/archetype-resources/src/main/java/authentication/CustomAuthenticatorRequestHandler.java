...
public class CustomAuthenticatorRequestHandler implements AuthenticatorRequestHandler<RequestModel> {
    private static final Logger _logger = LoggerFactory.getLogger(CustomAuthenticatorRequestHandler.class);

    private final AuthenticatorPluginConfig _config;
    private final OAuthClient _oauthClient;

    public CustomAuthenticatorRequestHandler(AuthenticatorPluginConfig config,
