...
A custom, Kotlin-based SAML Attribute Provider plugin for the Curity Identity Server, to enable retrieval of user attributes to issue to SAML assertions in custom ways.
